...
function StatCard({ title, value, delta }) {
    return (
        <div className="p-4 bg-gradient-to-r 
                    bg-gradient-to-r odd:from-blue-200 odd:to-cyan-200
                  from-violet-200 to-pink-200
                    rounded-lg text-gray-100 shadow-sm border border-gray-100">

            <div className="text-sm text-gray-500">{title}</div>
            <div className="mt-2 text-2xl text-slate-800 font-semibold">{value}</div>
    ...
    return (
        <main className="p-6">
            <div className="mb-4 flex justify-between items-center">
                <h1 className="text-2xl text-gray-800 font-semibold">Dashboard Page</h1>
